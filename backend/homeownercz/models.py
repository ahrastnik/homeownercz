...
class Property(models.Model):
    url = models.SlugField(primary_key=True, max_length=256, help_text='Link to the property listing')
    ...
    image_url = models.SlugField(max_length=512, help_text='Link to the image of the property')
